...
public class Route {
    ...
    public static void initAllRoutes() {
        ...
        p1 = new PointF(311, 483);
        p2 = new PointF(286, 803);
        ...
        p1 = new PointF(296, 848);
        p2 = new PointF(404, 1002);
        ...
        //-------------SaltLakeCity-Helena-------------//
        weight = 3;
        p = new Pair<>("Salt Lake City", "Helena");
        mappingName = "SaltLakeCity-Helena";
        p1 = new PointF(666, 679);
        p2 = new PointF(754, 514);
        ...
        //-------------Denver-Omaha-------------//
        weight = 4;
        p = new Pair<>("Denver", "Omaha");
        mappingName = "Denver-Omaha";
        p1 = new PointF(906, 748);
        p2 = new PointF(1141, 648);
        ...
        weight = 2;
        p = new Pair<>("KansasCity", "SaintLouis");
        mappingName = "KansasCity-SaintLouis-2";
        p1 = new PointF(1226, 743);
        p2 = new PointF(1348, 740);
        ...
        //-------------Duluth-Toronto-------------//
        weight = 6;
        p = new Pair<>("Duluth", "Toronto");
        mappingName = "Duluth-Toronto";
        p1 = new PointF(1256, 460);
        p2 = new PointF(1634, 399);
        ...
        //-------------Charleston-Miami-------------//
        weight = 4;
        p = new Pair<>("Charleston", "Miami");
        mappingName = "Charleston-Miami";
        p1 = new PointF(1807, 911);
        p2 = new PointF(1873, 1155);
